...
# Step 2: Go over all the extra hits of antitoxins in these strains
# and see if the antitoxin was found by one of the discarded toxins

antitoxins_out = {}
strains_out = {}

with open("/home/nasls/ANU/phd_project/TA-SYSTEMS/TA_systems_clean/set1/orphan_antitoxins_1/orphan_at_results/summary_per_strain.csv") as f_open:
    for line in f_open:
        #print(line)
        ...
        for p in partners:
            ...
            for i in range(0, len(strains[strain]["contigs"])):
                ...
                strains[strain]["starts"][i] - 5000 >= start  and start <= strains[strain]["starts"][i] + 5000:
                   flag = True
                   break
            if flag:
                ...
                #print(antitoxins_out[ID])
                strains_out[toks[0]]["Num_without_unfit"] += 1


# Step 3
with open("/home/nasls/ANU/phd_project/TA-SYSTEMS/TA_systems_clean/set1/orphan_antitoxins_1/orphan_at_results/full_summary_per_antitoxin.csv", "w") as out:
...
with open("/home/nasls/ANU/phd_project/TA-SYSTEMS/TA_systems_clean/set1/orphan_antitoxins_1/orphan_at_results/full_summary_per_strain.csv", "w") as out:
